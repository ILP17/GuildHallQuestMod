...
public class QuestBookConfigurator extends Item {
    public QuestBookConfigurator() {
        super(new Properties().group(GuildHallQuesting.TAB).maxStackSize(1));
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        {
            tooltip.add(new StringTextComponent("Allows you to create important quests, if you're an OP."));
        }
        else
        {
